...
$enderecos = $clienteController->viewEndereco();
...
<body>
    ...
    if (isset($_POST['submit'])) {
        if ($clienteController->verificaEndereco()) {
            ...
            if ($clienteController->addEndereco()) {
                echo "
                    <script>
                        Swal.fire({
                    ...
                    success: function (data) {
                        ...
                        if (data.length === 0) {
                            ...
                            data.forEach(function (endereco) {
                                var row = $('<tr></tr>');
                                row.append('<td>' + endereco.cepCliente + '</td>');
                                row.append('<td>' + endereco.logCliente + '</td>');
                                row.append('<td>' + endereco.numLocal + '</td>');
                                row.append('<td>' + endereco.bairroCliente + '</td>');
                                row.append('<td>' + endereco.cidadeCliente + '</td>');
                                row.append('<td>' + endereco.ufCliente + '</td>');
                                row.append('<td><button onclick="confirmarExclusao(' + endereco.idEnderecoCliente + ')">Excluir</button></td>');
                                row.append('<td><button onclick="confirmarEdicao(' + endereco.idEnderecoCliente + ',\'' + endereco.cepCliente + '\',\'' + endereco.logCliente + '\',\'' + endereco.numLocal +
                                    '\',\'' + endereco.bairroCliente + '\',\'' + endereco.cidadeCliente + '\',\'' + endereco.ufCliente + '\')">Editar</button></td>');
