...
<body>
    ...
    <div class="carousel">
        ...
        <div class="slides">
            <div class="slide">
                <img src="assets/img/Oferta3.png" alt="Slide 1">
            </div>
            <div class="slide">
                <img src="assets/img/Oferta2.png" alt="Slide 2">
            </div>
            <div class="slide">
                <img src="assets/img/Oferta1.png" alt="Slide 3">
            </div>
        </div>
    ...
    <div class="carousel-2">
        <?php foreach ($confeitarias as $confeitaria): ?>
            <div class="card">
                <a href="dados-confeitaria.php?c=<?php echo $confeitaria['idConfeitaria'] ?>">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="../view-confeitaria/<?php echo $produto['imgProduto']; ?>"
                            class="d-block ui-w-40 ui-bordered mr-4" alt="<?php echo $produto['nomeProduto']; ?>">
                    </div>
                    </a>
                    <div class="card-text">
