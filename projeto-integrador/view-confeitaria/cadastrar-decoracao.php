...
if (isset($_GET['action']) && $_GET['action'] == 'fetch_data') {
    ...
    if (isset($_POST['pesq']) && !empty($_POST['pesq'])) {
        ...
        $decoracoes = $decoracaoController->viewDecoracao();
    }
...
<body>
    ...
    <script>
                    ...
                    success: function (data) {
                        ...
                        if (data.length === 0) {
                            ...
                            data.forEach(function (decoracao) {
                                var row = $('<tr></tr>');
                                row.append('<td>' + decoracao.descDecoracao + '</td>');
                                row.append('<td><button onclick="confirmarExclusao(' + decoracao.idDecoracao + ')">Excluir</button></td>');
                                row.append('<td><button onclick="confirmarEdicao(' + decoracao.idDecoracao + ',\'' + decoracao.descDecoracao + '\')">Editar</button></td>');
        ...
        function confirmarEdicao(idDecoracao, descDecoracao) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const url = `editar-decoracao.php?id=${idDecoracao}&desc=${descDecoracao}`;
